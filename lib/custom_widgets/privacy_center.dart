  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Centro de privacidad', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
      body: SafeArea(
        child: Padding(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: const [
                              ...
                              SizedBox(height: 12),
                              Text('1. Identidad del Responsable', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 6),
                              ...
                              SizedBox(height: 8),
                              Text('2. Datos Personales Recabados', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 6),
                              ...
                              SizedBox(height: 8),
                              Text('3. Finalidades del Tratamiento', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 6),
                              Text('Las finalidades principales son: prestar el servicio, personalizar ofertas y mejorar la experiencia de usuario.'),
                              SizedBox(height: 8),
                              Text('4. Transferencia de Datos', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 6),
                              ...
                              SizedBox(height: 8),
                              Text('5. Derechos ARCO', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 6),
                              ...
                              SizedBox(height: 12),
                              Text('6. Cambios al Aviso de Privacidad', style: TextStyle(fontWeight: FontWeight.bold)),
                              SizedBox(height: 6),
